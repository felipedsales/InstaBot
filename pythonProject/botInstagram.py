...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(executable_path=r'A:\geckodriver.exe')
...
RoboBot = InstagramBot('insira seu usuario','insira sua senha')
RoboBot.login()